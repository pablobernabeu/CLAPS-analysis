...
# Export appendix content (model ladders and prior specifications) as markdown.
#
# These were pulled into the earlier report through Quarto include tags, keeping
# the model and prior definitions in step with R/03_define_priors.R and
# R/04_model_formulas.R without embedding large code blocks in the main text.
# The current report inlines its appendices, so this export is not presently
# wired into a report; it is kept as a utility for regenerating that content
